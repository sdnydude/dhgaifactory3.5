...
```bash
~/.claude/scripts/post-decision-logs.sh '{"title":"<short decision title>","choice":"<what was decided>","alternatives_rejected":"<what was considered and rejected>","rationale":"<why this choice was made>","domain":"<domain>","project_name":"dhg-ai-factory","source_file":"<file being discussed>","tags":["<tag1>","<tag2>"],"model_name":"claude-opus-4-6"}'
```
