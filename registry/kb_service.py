...
def search_source(
    ...
    """
    model_cls, extractor = SOURCE_CONFIG[source_name]
...
def kb_search(
    ...
    *,
    ...
    """Search across multiple KB sources. Returns (candidates, searched, failed)."""
    ...
    return all_candidates[:limit], searched_sources, failed_sources
