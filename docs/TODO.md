...
- **Branch state:** `lsp-setup` is 40+ commits ahead of master (+14865/-1180 across 55 files), zero pushed. Carries LSP Task 6 verification, full inbox-download Phase 1 + Phase 2 v2 (13/19 tasks), pdf-renderer service, inbox-repair merge, medkb v2 design spec. Merge-to-master decision pending.
