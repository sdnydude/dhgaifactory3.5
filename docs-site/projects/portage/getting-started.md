...
| portage-rembg | `http://10.0.0.251:7000` | [Background removal service](/portage/api/images) |
...
See the [Environment Variables](/portage/environment-variables) page for the full list.
...
- [Features](/portage/features) — every shipped feature and what makes it unique
- [API Reference](/portage/api/overview) — explore the REST API
- [App Structure](/portage/frontend/app-structure) — how the Next.js frontend is organized
- [Design System](/portage/frontend/design-system) — learn about the UI framework
- [Deployment](/portage/deployment) — Docker services, tunnel, and deploy ritual
