...
|----------------------------|------------------------------|
| ![workbench](/portage/img/verification/r1-workbench/a-inventory-workbench.png) | ![card click](/portage/img/verification/r1-workbench/b-card-click-detail.png) |

Keyboard navigation and the deep link:

| c — ArrowDown moves selection | e — ?item= deep link |
|-------------------------------|----------------------|
| ![arrowdown](/portage/img/verification/r1-workbench/c-arrowdown-selection.png) | ![deep link](/portage/img/verification/r1-workbench/e-deep-link.png) |

Edit persistence (PATCH → reload → restore):

| d1 — edited | d2 — persisted after reload | d3 — restored |
|-------------|-----------------------------|---------------|
| ![edited](/portage/img/verification/r1-workbench/d1-title-edited.png) | ![persisted](/portage/img/verification/r1-workbench/d2-title-persisted-after-reload.png) | ![restored](/portage/img/verification/r1-workbench/d3-title-restored.png) |

Listings focus:

| f — listing card focused in pane |
|----------------------------------|
| ![listings focus](/portage/img/verification/r1-workbench/f-listings-focus.png) |

Mobile intact (390×844):

| h1 — inventory (no workbench) | h2 — card link → item detail route |
|-------------------------------|------------------------------------|
| ![mobile inventory](/portage/img/verification/r1-workbench/h1-mobile-inventory.png) | ![mobile detail](/portage/img/verification/r1-workbench/h2-mobile-item-detail.png) |
