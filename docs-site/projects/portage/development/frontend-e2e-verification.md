...
| Read-only | Edit mode |
|-----------|-----------|
| ![read-only](/portage/img/verification/inline-edit/1-readonly.png) | ![editing](/portage/img/verification/inline-edit/2-editing.png) |

| Saved | Persisted after reload |
|-------|------------------------|
| ![saved](/portage/img/verification/inline-edit/3-saved.png) | ![persisted](/portage/img/verification/inline-edit/4-persisted-after-reload.png) |
...
|----------------|---------|------------------------|
| ![slider](/portage/img/verification/photo-tools/exposure-1-slider.png) | ![applied](/portage/img/verification/photo-tools/exposure-2-applied.png) | ![persisted](/portage/img/verification/photo-tools/exposure-3-persisted-after-reload.png) |

| Inline processing (no CTA page) | Before/after preview | White bg persisted after reload |
|--------------------------------|----------------------|--------------------------------|
| ![processing](/portage/img/verification/photo-tools/bg-1-inline-processing.png) | ![preview](/portage/img/verification/photo-tools/bg-2-before-after-preview.png) | ![white](/portage/img/verification/photo-tools/bg-3-white-persisted-after-reload.png) |
