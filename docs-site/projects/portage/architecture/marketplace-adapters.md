...
For the eBay account-takeover protection model and the SKU/User-Agent hardening that backs this publish path, see [eBay ATO & Publish Hardening](/portage/reference/ebay-ato-and-publish-hardening).
