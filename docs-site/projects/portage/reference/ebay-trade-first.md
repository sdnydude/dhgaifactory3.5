...
- **ATO-safe.** A burst of new SKUs in minutes is exactly the "rapid listing
  ...
  [eBay ATO & Publish Hardening](/portage/reference/ebay-ato-and-publish-hardening).
...
- [Marketplace Adapters](/portage/architecture/marketplace-adapters) — the adapter
...
- [eBay ATO & Publish Hardening](/portage/reference/ebay-ato-and-publish-hardening) —
  ...
  hardening
- [Listings API](/portage/api/listings) — the REST endpoints that drive this
  lifecycle
