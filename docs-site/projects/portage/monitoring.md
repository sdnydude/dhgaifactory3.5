...
Docker health checks poll these endpoints to determine container health status — see [Deployment → Health Checks](/portage/deployment#health-checks) for the per-container probe configuration.
