...
Deep Teal is the AI accent by principle: teal marks AI/intelligence surfaces (Porter), never purple — the DHG system deliberately avoids the AI industry's saturated purple (see [Style Guide](/portage/design/style-guide)).
