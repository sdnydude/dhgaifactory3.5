        ...
        return {
            ...
            "io_schema": {
                "inputs": {
                    ...
                    "therapeutic_area": {"type": "string", "required": True, "enum": THERAPEUTIC_AREAS},
                    "query_type": {
                        "type": "string",
    ...
    def _get_model_registry(self) -> dict:
        ...
        return {
            ...
            "claude_haiku": {
                ...
                "status": "available" if os.getenv("ANTHROPIC_API_KEY") else "no_api_key",
                "use_cases": ["extraction", "classification"],
            ...
            "qwen_local": {
                "provider": "ollama",
                "model_id": "qwen3:14b",
                "status": self._check_ollama("qwen3:14b"),
                "use_cases": ["local_synthesis", "cost_free", "offline"],
                "cost": {"input": 0.0, "output": 0.0},
                "context_window": 32000,
                "max_output": 8192,
                "local": True,
                "requires": "ollama with qwen3:14b pulled"
            }
        }
    
    def _check_ollama(self, model: str) -> str:
...
def build_graph() -> StateGraph:
    ...
    graph.set_entry_point("pubmed_search")
    graph.add_edge("pubmed_search", "perplexity_search")
...
async def run_research(
    ...
    """Run research - set use_local_llm=True for Qwen3 via Ollama"""
